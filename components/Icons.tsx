...
export const OwlIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2a8 8 0 0 1 8 8c0 3.5-3 8-8 12-5-4-8-8.5-8-12a8 8 0 0 1 8-8" />
    <circle cx="9" cy="9" r="2" fill="currentColor" />
    <circle cx="15" cy="9" r="2" fill="currentColor" />
    <path d="M12 14s1.5 1 3 0" />
    <path d="M2 10s2-4 5-4" />
    <path d="M22 10s-2-4-5-4" />
  </svg>
);
...
export const HomeIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <polyline points="9 22 9 12 15 12 15 12 15 22" />
  </svg>
);
...
export const BrushIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 21.5a2 2 0 0 0 2-2v-10c0-1.1-.9-2-2-2a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2Z" />
    <path d="M9 2a2 2 0 0 0-2 2v2.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5V4a2 2 0 0 0-2-2" />
    <path d="M14.5 17.5 12 15" />
...
export const PuzzleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19.439 10c.011.001.021.004.032.004.814 0 1.554-.316 2.112-.843l1.838 1.838c.527.558.843 1.298.843 2.112 0 .011-.004.021-.004.032a3 3 0 0 1 .527 5.856V19a3 3 0 0 1-3 3h-1.042a3 3 0 0 1-5.857.528c-.011.003-.021.004-.032.004-.814 0-1.554-.316-2.112-.843l-1.838-1.838a2.986 2.986 0 0 1-.843-2.112c0-.011.004-.021.004-.032a3 3 0 0 1-.527-5.856V5a3 3 0 0 1 3-3h1.042A3 3 0 0 1 19.439 10z" />
  </svg>
);
...
export const AbcBlockIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ChessIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2a3 3 0 0 0-3 3v1a2 2 0 0 0 2 2v2a3 3 0 0 0-2 2.83V16a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-3.17A3 3 0 0 0 13 10V8a2 2 0 0 0 2-2V5a3 3 0 0 0-3-3Z" />
    <path d="M7 17h10" />
    <path d="M5 21h14" />
  </svg>
);
